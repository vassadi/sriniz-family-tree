...
(FamilyTree._defaultConfig = function (e) {
            ...
            if (!a.notifierUI.show(e.notif)) {
              ...
              if (
                ...
                (t !== FamilyTree.action.centerNode &&
                  ...
                  (a.response = e);
                F = a.ui.svg(a.width(), a.height(), d, a.config, l);
                if (a._initialized) {
                  var h = a.getSvg(),
                    f = h.parentNode;
                  f.removeChild(h),
                    f.insertAdjacentHTML('afterbegin', F),
                ...
                var g = e.boundary,
                  T = g.maxX - g.minX,
                  b = g.maxY - g.minY,
                  F = a.ui.svg(T, b, [g.minX, g.minY, T, b], a.config, l, o);
                r(F);
              }
            }
          },
    ...
    if (null != r) {
      ...
      if (null != a) {
        ...
        FamilyTree.events.publish('ripple', [this, b]),
          u.setAttribute('x', b.ripple.rect ? b.ripple.rect.x : 0),
          u.setAttribute('y', b.ripple.rect ? b.ripple.rect.y : 0),
          u.setAttribute('width', b.ripple.rect ? b.ripple.rect.width : r.w),
          u.setAttribute('height', b.ripple.rect ? b.ripple.rect.height : r.h),
          u.setAttribute('rx', b.ripple.radius),
          u.setAttribute('ry', b.ripple.radius),
          ...
          for (var p in i[m]) {
            ...
            switch (p.toLowerCase()) {
              case 'd':
                ...
                break;
              case 'r':
                var u = a((d * s - s) / r) * (i[m][p] - t[m][p]) + t[m][p];
                e[m].setAttribute('r', u);
                break;
              case 'x1':
                u = a((d * s - s) / r) * (i[m][p] - t[m][p]) + t[m][p];
              ...
              case 'margin':
                if (i[m][p]) {
                  ...
                  for (var F in g)
                    b[F] = a((d * s - s) / r) * (T[F] - g[F]) + g[F];
                  var v = '';
                  for (F = 0; F < b.length; F++) v += parseInt(b[F]) + 'px ';
                  e[m] && e[m].style && (e[m].style[p] = v);
                }
                break;
              case 'scrolly':
                u = a((d * s - s) / r) * (i[m][p] - t[m][p]) + t[m][p];
  ...
  (FamilyTree.editUI.prototype.content = function (e, t, i, r, a) {
    var n,
      ...
      y = this.obj._get(e),
      u = FamilyTree.t(f.templateName, f.min, this.obj.getScale()),
      g = y[p],
      T = y[h];
      ...
      for (var b = 0; b < this.fields.length; b++) {
        ...
        if ('tags' != F) {
          for (var v = !1, x = 0; x < o.length; x++) {
            ...
            } else if (F == o[x].binding) {
              v = !0;
              break;
            }
            if (v) break;
          }
          v || o.push({ type: 'textbox', label: F, binding: F });
        }
      }
    ...
    if (
      ...
      for (b = 0; b < f.tags.length; b++) N.classList.add(f.tags[b]);
        ...
        for (var e = '', i = 0; i < o.length; i++) {
          ...
          if (Array.isArray(r)) {
            ...
            for (var a = 0; a < r.length; a++) {
              var l = r[a],
                s = FamilyTree.elements[l.type](y, l, 'unset', t);
              !FamilyTree.isNEU(s.id) &&
                FamilyTree.isNEU(n) &&
                FamilyTree.isNEU(s.value) &&
                (n = s.id),
                FamilyTree.isNEU(s.value) || I.push(`${l.label}: ${s.value}`),
                (e += s.html);
            }
            e += '</div>';
          } else {
            s = FamilyTree.elements[r.type](y, r, '280px', t);
            !FamilyTree.isNEU(s.id) &&
              FamilyTree.isNEU(n) &&
              FamilyTree.isNEU(s.value) &&
              (n = s.id),
      ...
      if (
        ...
        for (
          var u = 0,
            ...
            b = 2 * Math.PI * T,
            F = b / g - (2 * a.nodeCircleMenuButton.radius + 2);
          F < 0;
        ...
        for (var v in ((h = document.createElementNS(
          'http://www.w3.org/2000/svg',
          'g'
        ...
        f.menu)) {
          ...
          k.setAttribute('transform', 'matrix(1,0,0,1,0,0)'),
            k.setAttribute(FamilyTree.attr.control_node_circle_menu_name, v),
  ...
  (FamilyTree.wrapText = function (e, t) {
    ...
    if (
      ...
      for (var y = h.getComputedTextLength(), u = 2; y > c; )
        (h.textContent = e.substring(0, e.length - u)),
          (h.textContent += '...'),
          (y = h.getComputedTextLength()),
          u++;
      return u > 2
      ...
      for (var v = 1, x = 1; x < g.length; x++) {
        ...
        if (
          ...
          (b = document.createElementNS(p, 'tspan')).setAttributeNS(
            ...
            b.setAttributeNS(null, 'y', s + T * u),
            b.setAttributeNS(null, 'text-anchor', d),
            (F = document.createTextNode(g[x])),
            b.appendChild(F),
            h.appendChild(b),
            u++;
        }
  ...
  (FamilyTree.prototype._pagesA100 = function (e, t, i) {
    ...
    for (
      var p = c.w * (100 / i), h = c.h * (100 / i), f = l, y = o, u = [];
      f < s + l;

    ) {
      for (; y < d + o; ) {
        var g = [f, y, p, h];
        (g = g.join()), u.push({ vb: g, innerSize: c, size: m }), (y += h);
      }
      (f += p), (y = o);
    }
    return u;
  ...
  (FamilyTree._importSetColumnNames = function (e, t) {
    if (-1 == e.indexOf('id') || -1 == e.indexOf('pid')) {
      ...
      for (f = 0; f < e.length; f++) {
        ...
        b.appendChild(y), T.appendChild(b);
      }
      var F = document.createElement('BUTTON');
      (F.innerHTML = 'Import'),
        (F.style.fontSize = '16px'),
        (F.style.color = 'rgb(122, 122, 122)'),
        (F.style.padding = '5px 20px'),
        (F.style.margin = '20px auto'),
  ...
  (FamilyTree.prototype._nodeCircleNodeMenuItemMouseDownHandler = function (
    ...
    if (n.draggable) {
        ...
        v = function (t) {
          if (
            ...
            p.classList &&
              ...
              p.classList.remove('bft-cursor-nodrop'),
              p.classList.remove('bft-cursor-copy')),
            p.removeEventListener(i.move, F),
            p.removeEventListener(i.up, v),
            i.leave && p.removeEventListener(i.leave, v),
            s.id == c || null == c)
          )
            return (
              p.removeChild(f),
      ...
      p.addEventListener(i.move, F),
        p.addEventListener(i.up, v),
        i.leave && p.addEventListener(i.leave, v);
    }
  }),
  (FamilyTree.prototype._nodeMouseDownHandler = function (e, t, i) {
    if (this.config.enableDragDrop) {
      ...
      var s = this,
        ...
        f = s.getScale(),
        y = e.cloneNode(!0);
      y.setAttribute('data-n-id', 'draging'),
      ...
      var u = function (e, t) {
        ...
        T = function (t) {
          if (
            ...
            return (
              e._dragEventFired &&
                FamilyTree.events.publish('drop', [s, n.id, void 0, y]),
              d.removeChild(y),
              void (s._gragStartedId = null)
            );
          var r = s.getNode(l);
          if (!1 === FamilyTree.events.publish('drop', [s, n.id, r.id, y]))
            return u(l, o), d.removeChild(y), void (s._gragStartedId = null);
          if (s.canUpdateLink(n.id, l)) {
            var a = s.get(n.id);
            (a.pid = l), (a.stpid = null), s.updateNode(a, null, !0);
          } else d.removeChild(y), u(l, o);
  ...
  (FamilyTree.manager._iterate = function (e, t, i, r, a, n, l, o, s, d, c, m) {
    ...
    if (
      ...
      if (
        ...
        for (
          var h = [], f = 0, y = 0, u = 0;
          u < t.parent.children.length;
          u++
        ) {
          -1 == (g = t.parent.children[u]).tags.indexOf('partner') &&
        ...
        ((FamilyTree.MIXED_LAYOUT_ALL_NODES &&
          h.length > 1 &&
          h.length == t.parent.children.length - f - y) ||
      ...
      for (h = [], f = 0, y = 0, u = 0; u < t.parent.children.length; u++) {
        var g;
        -1 == (g = t.parent.children[u]).tags.indexOf('partner') &&
        -1 == g.tags.indexOf('left-partner') &&
        -1 == g.tags.indexOf('right-partner') &&
      ...
      ((FamilyTree.MIXED_LAYOUT_ALL_NODES &&
        h.length > 1 &&
        h.length == t.parent.childrenIds.length - f - y) ||
        (!FamilyTree.MIXED_LAYOUT_ALL_NODES && h.length > 1)) &&
        (o[t.pid] = h);
    }
    t.stChildren.length &&
  ...
  (FamilyTree.manager.__createNodes = function (e, t, i, r, a, n, l, o) {
    for (
      ...
      var f = FamilyTree._getTemplate(m, i.tags, i.template),
        y = new FamilyTree.node(p.id, p.pid, m, f);
      FamilyTree.isNEU(p.ppid) || (y.ppid = p.ppid),
        FamilyTree.isNEU(p.stpid) || (y.stpid = p.stpid),
        null != i.orderBy &&
          (y.order = FamilyTree.manager._getOrderFieldValue(p, i.orderBy)),
        (e[p.id] = y),
        s.push(p.id);
    }
    null != i.orderBy &&
    ...
    for (c = 0; c < s.length; c++) {
      var u = s[c],
        ...
        T = e[y.stpid],
        b = e[y.pid];
      if ((T || (y.stpid = null), b || (y.pid = null), T)) {
        var F = n ? n[T.id] : null;
        F && (T.min = F.min), T.stChildrenIds.push(y.id);
      } else
        b
          ? (g && ((y.collapsed = g.collapsed), (y.min = g.min)),
            b.childrenIds.push(y.id))
          : (g && ((y.collapsed = g.collapsed), (y.min = g.min)),
            t.push(y),
            l.push(y.id));
      r == FamilyTree.action.init && (y.min = FamilyTree._getMin(y, i));
    }
  }),
  (FamilyTree.manager._createNodes = function (e) {
        ...
        if (m) {
          ...
          if (!f) {
            if (!FamilyTree.isNEU(m.pid))
              (z = (b = o[m.pid]).childrenIds.indexOf(m.id)) > -1 &&
    ...
    if (r == FamilyTree.action.init && t.expand && t.expand.nodes && null == l)
      for (c = 0; c < t.expand.nodes.length; c++) {
        ...
        for (
          ...
          FamilyTree.manager._addExpandedNodeIdsIterate(g, o, u);
          g;
      ...
      for (var F = o[a.id]; F; ) {
        if (
          (u.push(F.id),
          a.options.parentState === FamilyTree.COLLAPSE_PARENT_NEIGHBORS && F)
        )
          for (c = 0; c < F.childrenIds.length; c++) {
            (R = o[F.childrenIds[c]]).collapsed = !0;
          }
      ...
      if (a.options.childrenState === FamilyTree.COLLAPSE_SUB_CHILDRENS)
        for (c = 0; c < F.childrenIds.length; c++) {
          (x = o[F.childrenIds[c]]).collapsed = !1;
    ...
    var _ = [],
      ...
      C = [];
    for (c = 0; c < s.length; c++)
      FamilyTree.manager._iterate(s[c], s[c], o, 0, _, w, k, S, '', u, C, e);
    if (
    ...
    for (c = 0; c < C.length; c++) {
      ...
      for (v = 0; v < g.children.length; v++) {
        (R = g.children[v]).isAssistant
          ? N.push(R.id)
          : -1 != R.tags.indexOf('right-partner')
          ? ((R.isPartner = 1), (R.children = []), I.push(R.id))
          ...
          ? -1 != R.tags.indexOf('partner') && L % 2
            ...
            : R.parentPartner
            ? (M[R.parentPartner.id] || (M[R.parentPartner.id] = []),
              M[R.parentPartner.id].push(R.id))
            : N.push(R.id)
          : ((R.isPartner = 1), (R.children = []), I.push(R.id), L++);
      }
      g.children = [];
      var B = [];
      for (v = 0; v < I.length; v++) {
        M[(R = o[I[v]]).id] ? g.children.push(R) : g.children.splice(0, 0, R);
        for (var H = 0; H < R.childrenIds.length; H++) B.push(R.childrenIds[H]);
      }
      var D = [];
      for (v = 0; v < A.length; v++) {
        M[(R = o[A[v]]).id] ? g.children.push(R) : g.children.splice(0, 0, R);
        for (H = 0; H < R.childrenIds.length; H++) D.push(R.childrenIds[H]);
      }
      for (v = 0; v < D.length; v++) {
        (R = o[D[v]]).collapsed ||
          ((R.parentPartner = R.parent),
          (R.parent = g),
          (R.isChildOfPartner = !0),
          g.children.push(R));
      }
      for (v = A.length - 1; v >= 0; v--)
        if (M[A[v]])
          for (y = 0; y < M[A[v]].length; y++)
            g.children.push(o[M[A[v]][y]]),
              E++,
              -1 == O.indexOf(A[v]) && O.push(A[v]);
      ...
      for (v = 0; v < I.length; v++)
        if (M[I[v]])
          for (y = 0; y < M[I[v]].length; y++)
            g.children.push(o[M[I[v]][y]]),
              P++,
              -1 == U.indexOf(I[v]) && U.push(I[v]);
        ...
        for (v = 0; v < g.subLevels; v++) {
          var z,
            j = new FamilyTree.node(
              g.id + '_sub_level_index_' + v,
              g.pid,
              [],
              'subLevel'
            );
          if ((FamilyTree.manager._initDinamicNode(j, g.lcn), (b = g.parent)))
            (z = b.children.indexOf(g)) > -1 &&
              (b.children.splice(z, 1), b.children.splice(z, 0, j)),
              j.children.push(g),
              (j.parent = b),
              (g.parent = j),
              (o[j.id] = j);
    ...
    for (var $ in w) {
      ...
      for (v = b.children.length - 1; v >= 0; v--) {
        (R = b.children[v]).isAssistant
          ? ((R.parent = null), b.children.splice(v, 1), Y.splice(0, 0, R.id))
          : R.isPartner ||
            (R.parent &&
              S[R.parent.id] &&
              j &&
              ...
              (Object.defineProperty(
                S,
                j.id,
                Object.getOwnPropertyDescriptor(S, R.parent.id)
              ),
              delete S[R.parent.id]),
            (R.parent = j),
            j.children.unshift(R),
            b.children.splice(v, 1));
      }
      if (Y.length % 2) {
        var X = o[Y[Y.length - 1]],
          q = new FamilyTree.node(X.id + '_mirror', b.pid, [], 'mirror');
        FamilyTree.manager._initDinamicNode(q, X.lcn, !0),
          (X._m = q.id),
          (q.isAssistant = !0),
          (q.w = X.w),
          (q.h = X.h),
        ...
        if (
          ...
          if (
            ...
            for (c = ie.childrenIds.length - 1; c >= 0; c--) {
              for (R = o[ie.childrenIds[c]], v = 0; v < b.children.length; v++)
                b.children[v].id == R.id && b.children.splice(v, 1);
              if (
                ((R.parent = null),
                (R.layout = FamilyTree.tree),
                ie.layout == FamilyTree.treeRightOffset &&
                  oe.splice(0, 0, R.id),
                ie.layout == FamilyTree.treeLeftOffset ||
                  ie.layout == FamilyTree.treeRightOffset)
                ...
                FamilyTree.manager._initDinamicNode(se, R.lcn),
            ...
            for (V = 1, v = oe.length - 1; v >= 0; v--)
              if (v % 2 && v != oe.length - 1) {
                ...
                FamilyTree.manager._initDinamicNode(W, b.lcn),
                  ...
                  oe.splice(v, 0, W.id),
                  V++;
              } else v % 2 && oe.splice(v, 0, j.id);
            for (v = 0; v < oe.length; v += 3) {
              G = null;
              0 == v && (G = b);
              (K = o[oe[v]]), (J = o[oe[v + 1]]), (Z = o[oe[v + 2]]);
              0 != v && (G = o[oe[v - 3]]),
                0 == v || J || (G = o[oe[v - 2]]),
                (K.parent = G),
                G.children.push(K),
  ...
  (FamilyTree.manager._getResponse = function (
    ...
    if (
      ((g.top = o - r.padding),
      (g.left = l - r.padding),
      (g.bottom = n + r.padding - t / v),
      (g.right = a + r.padding - e / v),
      (g.maxX = a),
      (g.minX = l),
      (g.maxY = n),
      (g.minY = o),
      ...
      (x = Math.ceil(e / v)), (_ = Math.ceil(t / v)), (w = 0), (k = 0);
    ...
    for (var I = 0; I < d.length; I++)
      FamilyTree.manager._iterate2(d[I], p, r, s, c, m, u, h, i, T);
    return {
      animations: T,
      boundary: g,
      viewBox: s,
  ...
  (FamilyTree.manager._iterate2 = function (e, t, i, r, a, n, l, o, s, d) {
    if (FamilyTree.manager._isVisible(e, i, r, a)) {
      ...
      if (
        ...
        if ((y = t[n.id])) {
          ...
          m && (c = { x: y.x + y.w / 2 - e.w / 2, y: y.y + y.h / 2 - e.h / 2 });
        }
      } else if (
    ...
    for (var u = 0; u < e.stChildren.length; u++)
      FamilyTree.manager._iterate2(e.stChildren[u], t, i, r, a, n, l, o, s, d);
    for (u = 0; u < e.children.length; u++)
      FamilyTree.manager._iterate2(e.children[u], t, i, r, a, n, l, o, s, d);
  }),
  ...
  (FamilyTree.manager.__createNodes = function (e, t, i, r, a, n, l, o) {
    for (var s = i.nodes, d = [], c = {}, m = {}, p = 0; p < s.length; p++) {
      ...
      var y = o.searchUI.addMatchTag(f.id);
      !0 === y ? h.unshift('match') : !1 === y && h.unshift('no-match'),
        f.gender && h.push(f.gender);
      var u = FamilyTree._getTemplate(h, i.tags, i.template);
      f.templateName && (u = f.templateName);
      var g = new FamilyTree.node(f.id, f.pid, h, u);
      (g.ftChildrenIds = []),
        (g.rids = []),
    ...
    for (p = 0; p < d.length; p++) {
      ...
      if (b) {
        var F = [];
        FamilyTree.manager._iterateSetRootIds(b.id, b.id, m, c, e, F),
          l.push(F);
      }
    }
    for (p = 0; p < l.length; p++)
      for (var v = 0; v < l.length; v++)
        if (v != p) {
          for (var x = l[p], _ = l[v], w = !1, k = 0; k < x.length; k++)
            if (_.has(x[k])) {
              w = !0;
              break;
            }
          w && ((l[p] = x.concat(_).unique()), (l[v] = []));
        }
  ...
  (FamilyTree.manager._iterateFT = function (e, t, i, r, a, n, l, o, s) {
    ...
    if (
      ...
      var y = a ? a[p.id] : null;
      y && (p.min = y.min), p.stChildrenIds.push(c.id);
    } else
      h || f
      ...
      if (g) {
        ...
        if (
          ...
          for (var b = 0; b < i[g.id].length; b++) {
            var F = r[i[g.id][b]];
            F &&
              (FamilyTree.isNEU(F.fid) || FamilyTree.isNEU(F.mid)) &&
    ...
    node: function (e, t, i, r, a, n, l, o, s, d) {
      ...
      for (var h in l) {
        var f,
          y = l[h];
        t && (f = t[y]);
        var u = FamilyTree._lblIsImg(r, h);
        if (
          ((p.value = f),
          (p.element = c[h]),
          (p.name = y),
      ...
      var b = FamilyTree._getPosition(i, e, a, n),
        F = 'node';
      Array.isArray(e.tags) && e.tags.length && (F += ' ' + e.tags.join(' ')),
        e.layout && (F += ' tree-layout');
      var v = '';
      e.lcn && (v = 'lcn="' + e.lcn + '"');
      ...
      if (r !== FamilyTree.action.exporting && !t.isSplit) {
        ...
        if (t.childrenIds.length > 0) {
          ...
          if (-1 != n.indexOf('{children-count}')) {
            var y = FamilyTree.childrenCount(e, t);
            n = n.replace('{children-count}', y);
          }
          if (-1 != n.indexOf('{children-total-count}')) {
            var u = FamilyTree.childrenTotalCount(e, t);
    ...
    link: function (e, t, i, r, a, n) {
      ...
      for (y = 0; y < e.children.length; y++) {
        var u = e.children[y],
          ...
          b = (s = FamilyTree.t(u.templateName, u.min, i)).link;
        if (u.isChildOfPartner)
          switch (o.orientation) {
            case FamilyTree.orientation.top:
            case FamilyTree.orientation.top_left:
              var F = 1 == u.layout ? void 0 : g.minY - (g.minY - h.maxY) / 2;
              T = FamilyTree.ui._linkTopToBottom(u.parentPartner, u, s, c, F);
              break;
            case FamilyTree.orientation.bottom:
            case FamilyTree.orientation.bottom_left:
              F = 1 == u.layout ? void 0 : g.maxY - (g.maxY - h.minY) / 2;
              T = FamilyTree.ui._linkBottomToTop(u.parentPartner, u, s, c, F);
              break;
            case FamilyTree.orientation.right:
            case FamilyTree.orientation.right_top:
              F = 1 == u.layout ? void 0 : g.maxX - (g.maxX - h.minX) / 2;
              T = FamilyTree.ui._linkRightToLeft(u.parentPartner, u, s, c, F);
              break;
            case FamilyTree.orientation.left:
            case FamilyTree.orientation.left_top:
              F = 1 == u.layout ? void 0 : g.minX - (g.minX - h.maxX) / 2;
              T = FamilyTree.ui._linkLeftToRight(u.parentPartner, u, s, c, F);
          }
        else if (f && -1 != f.ids.indexOf(u.id))
          switch (o.orientation) {
            case FamilyTree.orientation.top:
            case FamilyTree.orientation.top_left:
              T = FamilyTree.ui._linkPpTop(f, e, u, g, h, s);
              break;
            case FamilyTree.orientation.bottom:
            case FamilyTree.orientation.bottom_left:
              T = FamilyTree.ui._linkPpBottom(f, e, u, g, h, s);
              break;
            case FamilyTree.orientation.right:
            case FamilyTree.orientation.right_top:
              T = FamilyTree.ui._linkPpRight(f, e, u, g, h, s);
              break;
            case FamilyTree.orientation.left:
            case FamilyTree.orientation.left_top:
              T = FamilyTree.ui._linkPpLeft(f, e, u, g, h, s);
          }
        else {
          var v =
              u.isAssistant &&
              u.rightNeighbor &&
              u.rightNeighbor.isAssistant &&
              u.parent == u.rightNeighbor.parent,
            x =
              u.isAssistant &&
              u.leftNeighbor &&
              u.leftNeighbor.isAssistant &&
              u.parent == u.leftNeighbor.parent;
          if (
            (v || 2 == u.layout) &&
            u.rightNeighbor &&
            ...
            switch (o.orientation) {
              ...
              case FamilyTree.orientation.bottom:
              case FamilyTree.orientation.bottom_left:
                T = FamilyTree.ui._linkRightToLeft(u.rightNeighbor, u, s, c);
                break;
              case FamilyTree.orientation.right:
              case FamilyTree.orientation.right_top:
              case FamilyTree.orientation.left:
              case FamilyTree.orientation.left_top:
                T = FamilyTree.ui._linkBottomToTop(u.rightNeighbor, u, s, c);
            }
          else if (
            (x || 2 == u.layout) &&
            u.leftNeighbor &&
            ...
            switch (o.orientation) {
              ...
              case FamilyTree.orientation.bottom:
              case FamilyTree.orientation.bottom_left:
                T = FamilyTree.ui._linkLeftToRight(u.leftNeighbor, u, s, c);
                break;
              case FamilyTree.orientation.right:
              case FamilyTree.orientation.right_top:
              case FamilyTree.orientation.left:
              case FamilyTree.orientation.left_top:
                T = FamilyTree.ui._linkTopToBottom(u.leftNeighbor, u, s, c);
            }
          else
            switch (o.orientation) {
              case FamilyTree.orientation.top:
              case FamilyTree.orientation.top_left:
                if (1 == u.isPartner)
                  T = FamilyTree.ui._linkLeftToRight(e, u, s, m);
                else if (2 == u.isPartner)
                  T = FamilyTree.ui._linkRightToLeft(e, u, s, m);
                else {
                  F = 1 == u.layout ? void 0 : g.minY - (g.minY - h.maxY) / 2;
                  T = FamilyTree.ui._linkTopToBottom(e, u, s, c, F);
                }
                break;
              case FamilyTree.orientation.bottom:
              case FamilyTree.orientation.bottom_left:
                if (1 == u.isPartner)
                  ...
                  F = 1 == u.layout ? void 0 : g.maxY - (g.maxY - h.minY) / 2;
                  T = FamilyTree.ui._linkBottomToTop(e, u, s, c, F);
                }
                break;
              case FamilyTree.orientation.right:
              case FamilyTree.orientation.right_top:
                if (1 == u.isPartner)
                  T = FamilyTree.ui._linkTopToBottom(e, u, s, m);
                else if (2 == u.isPartner)
                  T = FamilyTree.ui._linkBottomToTop(e, u, s, m);
                else {
                  F = 1 == u.layout ? void 0 : g.maxX - (g.maxX - h.minX) / 2;
                  T = FamilyTree.ui._linkRightToLeft(e, u, s, c, F);
                }
                break;
              case FamilyTree.orientation.left:
              case FamilyTree.orientation.left_top:
                if (1 == u.isPartner)
                  ...
                  F = 1 == u.layout ? void 0 : g.minX - (g.minX - h.maxX) / 2;
                  T = FamilyTree.ui._linkLeftToRight(e, u, s, c, F);
                }
            }
        }
  ...
  (FamilyTree.pdfPrevUI._handler = function (e, t, i) {
    ...
    for (
      ...
      var y = p.getElementById('bft-header'),
        u = p.getElementById('bft-footer');
      if (y) {
        var g = n - y.offsetHeight - 7;
        y.style.top = g + 'px';
      }
      if (u) {
        var T = l - u.offsetHeight - 7;
        u.style.bottom = T + 'px';
      }
      p.close();
    }
    ...
    function n(t, n, l) {
      ...
      if (t.sl == n.sl)
        switch (((d = n), p.orientation)) {
          ...
          case FamilyTree.orientation.left_top:
            (y.p = t.x),
              (y.q = t.y + t.h / 2 + h.expandCollapseSize),
              (y.r = a.minX - f),
              (y.s = t.y + t.h / 2 + h.expandCollapseSize),
              s.push([y.p, y.q]),
              s.push([t.x - f / 3, y.q]),
              (h = FamilyTree.t(d.templateName, d.min, r)),
              s.push([
        ...
        for (var u = t; null == d; ) {
          ...
          if (
            ...
            for (; F; ) {
              ...
              FamilyTree._intersects(F, y, e.config) &&
                ((y = FamilyTree._addPoint(F, s, e.config, y, c)), (g = !0)),
                (F = F.rightNeighbor);
            }
          }
          if (!g) {
            var v = s[s.length - 1][0],
              x = 0;
            if (T.parent)
              switch (
                ((f = p.levelSeparation),
                ...
                case FamilyTree.orientation.left:
                case FamilyTree.orientation.left_top:
                  (v = T.parent.x + T.parent.w + f * (2 / 3)),
                    (x = s[s.length - 1][1]);
                  break;
                case FamilyTree.orientation.right:
                case FamilyTree.orientation.right_top:
                  (v = T.parent.x - f * (2 / 3)), (x = s[s.length - 1][1]);
              }
            s.push([v, x]);
          }
          u = T;
  ...
  (FamilyTree._search.search = function (e, t, i, r, a, n, l) {
    ...
    for (var m = {}, p = 0; p < e.length; p++)
      for (var h = e[p], f = 0; f < i.length; f++) {
        var y = i[f];
        if (!FamilyTree.isNEU(h[y])) {
          var u = h[y];
          if (
            null != (t = FamilyTree._search.searchAndComputeScore(d, u, y, n))
          ) {
            var g = h.id;
            if (m[g]) {
              if (m[g] && m[g] < t.__score) {
                ...
                FamilyTree._search.addNodeToResult(o, r, h, t, y, a);
              }
            } else
              (m[g] = t.__score),
                FamilyTree._search.addNodeToResult(o, r, h, t, y, a);
  ...
  (FamilyTree._search.searchAndComputeScore = function (e, t, i, r) {
    ...
    r && r[i] && (g = r[i]),
      ...
      d > 0 && (d = (d / 100) * 10),
      g > 0 && (g = (g / 100) * 20);
    var T = Math.round(1e4 * (f + y + u + d + g));
    n.sort(function (e, t) {
  ...
  (FamilyTree.prototype.showTreeMenu = function (e) {
    ...
    var F = { nodes: m, node: c };
    FamilyTree.events.publish('node-tree-menu-show', [this, F]),
      F.nodes.push(F.node),
      (this.config.nodes = F.nodes),
      (c = this.get(e));
    var v = this;
  ...
  (FamilyTree.local._setPositions = function (e, t, i) {
    for (var r = {}, a = {}, n = {}, l = 0; l < e.length; l++) {
      if ((p = e[l]).stContainerNodes)
        for (var o = p.stContainerNodes.length - 1; o >= 0; o--) {
          var s = p.stContainerNodes[o],
          ...
          s._m && ((s._m.w = s.w), (s._m.h = s.h)), (r[s.id] = d);
        }
    }
    ...
    for (l = 0; l < e.length; l++) {
      var p;
      if ((p = e[l]).stContainerNodes)
        for (o = 0; o < p.stContainerNodes.length; o++) {
          var h = (s = p.stContainerNodes[o]).x,
            f = s.y;
          void 0 !== a[p.id] &&
            void 0 !== a[p.id][s.id] &&
            (h += a[p.id][s.id]),
            void 0 !== n[p.id] &&
              void 0 !== n[p.id][s.id] &&
              (f += n[p.id][s.id]);
          for (var y = 0; y < s.stChildren.length; y++) {
            var u = s.stChildren[y];
            FamilyTree.local._lastWalk(u, h, f, r[s.id], s.padding);
          }
        }
    }
    i();
  ...
  (FamilyTree.local._walk = function (e, t) {
    for (
      ...
      var o = t[e[l].lcn ? e[l].lcn : 'base'];
      0 == l - (s = parseInt(l / o.columns)) * o.columns && (n = []),
        FamilyTree.local._firstWalk(e[l], 0, r, n, o);
    }
    for (l = 0; l < e.length; l++) {
      (o = t[e[l].lcn ? e[l].lcn : 'base']),
        (s = parseInt(l / o.columns)),
        o.columns;
      var s,
        d = 0;
      switch (
        (s > 0 && (d = a[s - 1] + o.siblingSeparation),
        FamilyTree.local._secondWalk(e[l], 0, 0, d, r, i, o),
        (a[s] = i.maxY - i.minY),
        o.orientation)
      ) {
        case FamilyTree.orientation.right:
  ...
  (FamilyTree.local._firstWalk = function (e, t, i, r, a) {
    if (!e.isPartner) {
      ...
      if (
        ...
        for (var l = e.children.length, o = 0; o < l; o++)
          FamilyTree.local._firstWalk(e.children[o], t + 1, i, r, a);
        ...
        if (
          ...
          if (e.isAssistant) m = a.assistantSeparation;
            ...
            (p = FamilyTree.local._size(n.parent, a)),
              (h = FamilyTree.local._rightMidPoint(n, a));
            (m = n.parent.partnerSeparation + p / 2 - h) <
        ...
        if (e.isAssistant) m = a.assistantSeparation;
          ...
          var p = FamilyTree.local._size(n.parent, a),
            h = FamilyTree.local._rightMidPoint(n, a);
          (m = n.parent.partnerSeparation + p / 2 - h) < a.siblingSeparation &&
            (m = a.siblingSeparation);
        }
        e._prelim =
          n._prelim + FamilyTree.local._nodeWithPartnersSize(n, a) + m;
  ...
  (FamilyTree.local._secondWalk = function (e, t, i, r, a, n, l) {
    if (t <= FamilyTree.MAX_DEPTH && !e.isPartner) {
      var o,
        s = e._prelim + i,
        d = r,
        c = 0;
      if (((c = a[t]), (o = FamilyTree.local._getNodeHeight(e, l)), e.layout)) {
        var m = 0,
          p = 0,
          h = 0,
          f = 0;
        e.leftNeighbor &&
          ...
          e.rightNeighbor &&
            ...
            ((p = FamilyTree.local._getNodeHeight(e.rightNeighbor, l)),
          ...
          (c = Math.max(o, m, p, h, f));
      }
      switch (
        ((e.x = s),
        (e.y = d),
        e.hasPartners && FamilyTree.local.nodeHasPartnersPosition(e, l, c),
      ...
      if ((FamilyTree._setMinMaxXY(e, n), 0 != e.children)) {
        var u = l.levelSeparation;
        e.layout && (u = l.mixedHierarchyNodesSeparation);
        var g = 0;
        if (
      ...
      null != T && FamilyTree.local._secondWalk(T, t, i, r, a, n, l);
    } else FamilyTree.local.nodeIsPartnerPosition(e, l, a, t);
  }),
  (FamilyTree.local._lastWalk = function (e, t, i, r, a) {
    (e.x += t + a[3] - r.minX), (e.y += i + a[0] - r.minY);
    for (var n = e.children.length, l = 0; l < n; l++) {
      var o = e.children[l];
      FamilyTree.local._lastWalk(o, t, i, r, a);
    }
  }),
    ...
    if (!e.isPartner)
      for (
        var a = FamilyTree.local._fChild(e),
          n = a.leftNeighbor,
          l = 1,
          o = FamilyTree.MAX_DEPTH - t;
        null != a && null != n && l <= o;

      ) {
        for (var s = 0, d = 0, c = a, m = n, p = 0; p < l; p++)
          (c = c.parent),
            (m = m.parent),
            (s += c._modifier),
            (d += m._modifier);
        var h = r.subtreeSeparation;
        2 == e.layout && (h = r.mixedHierarchyNodesSeparation);
        var f =
          n._prelim +
          d +
        ...
        l++,
          null !=
            (a = FamilyTree.local._hasChildren(a)
              ...
              : FamilyTree.local._getLeftmost(e, 0, l)) && (n = a.leftNeighbor);
      }
  }),
  ...
  (FamilyTree.local._getLeftmost = function (e, t, i) {
    ...
    for (var r = e.children.length, a = 0; a < r; a++) {
      var n = e.children[a];
      if (!n.isPartner) {
        var l = FamilyTree.local._getLeftmost(n, t + 1, i);
        if (null != l) return l;
      }
    }
    return null;
      ...
      case FamilyTree.orientation.bottom_left:
        ...
        for (var f = 0; f < e.parent.children.length; f++) {
          1 == (y = e.parent.children[f]).isPartner
            ? ((l = e.parent.x + e.parent.w + e.parent.partnerSeparation),
              p
                ? ((o =
                    e.parent.y -
                    (i[r - 1] - e.parent.h) / 2 +
                  ...
                  (m = y.h),
                  (p = !1))
                : ((o += m + t.partnerNodeSeparation), (m = y.h)),
              (y.x = l),
              (y.y = o))
            : 2 == y.isPartner &&
      ...
      case FamilyTree.orientation.left_top:
        ...
        for (f = 0; f < e.parent.children.length; f++) {
          ...
          (y = e.parent.children[f]) &&
            (1 == y.isPartner
              ? ((o = e.parent.y + e.parent.h + e.parent.partnerSeparation),
                p
                  ? ((l =
                      e.parent.x -
                      (i[r - 1] - e.parent.w) / 2 +
                    ...
                    (m = y.w),
                    (p = !1))
                  : ((l += m + t.partnerNodeSeparation), (m = y.w)),
                (y.x = l),
                (y.y = o))
              : 2 == y.isPartner &&
  ...
  (FamilyTree.local._centerGroupIfBidirectionalChart = function (
    ...
    for (
      ...
      (null === s || t.stChildren[c][a] > s + t.stChildren[c][o]) &&
        (s = t.stChildren[c][a] + t.stChildren[c][o]),
        (null === d || d < t.stChildren[c][a]) && (d = t.stChildren[c][a]);
    i[e.id] || (i[e.id] = {});
    var m = (s - d) / 2 + d,
      p = r[l] - s + (s - d) / 2;
    p > m
      ? ((i[e.id][t.id] = p - m), (t[o] = 2 * p))
      : ((i[e.id][t.id] = 0), (t[o] = 2 * m));
  });
